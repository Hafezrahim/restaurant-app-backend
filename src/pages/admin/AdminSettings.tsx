...
import { getDeliveryZones, saveDeliveryZones, DeliveryZone } from "@/data/deliveryZones";
...
const AdminSettings = () => {
  ...
  const [description, setDescription] = useState("مطعم متخصص في المأكولات السعودية الأصيلة");
  const [email, setEmail] = useState("info@alasala.com");
  const [phone, setPhone] = useState("+966 50 123 4567");
  const [address, setAddress] = useState("الرياض، حي النخيل، شارع الملك فهد");
  ...
  const handleAddZone = () => {
    ...
    setDeliveryZones((prev) => [
      ...prev,
      {
        ...
        estimatedTime: newZoneTime.trim() || "30-45",
      },
    ]);
    setNewZoneName("");
    setNewZonePrice("");
  ...
  const [stcPayEnabled, setStcPayEnabled] = useState(true);

  // Custom Payment Methods
  const [customPaymentMethods, setCustomPaymentMethods] = useState<
    { id: string; name: string; description: string; emoji: string; enabled: boolean }[]
  >([]);
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
            ...
            <div className="flex items-center justify-between p-4 bg-muted/30 rounded-xl">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  السماح للعملاء بطلب التوصيل للمنزل
                </p>
              </div>
                  ...
                  <div key={zone.id} className="flex items-center justify-between p-4 bg-muted/30 rounded-xl">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          {zone.price} {currency.symbol} • {zone.estimatedTime} دقيقة
                        </p>
                      </div>
                    </div>
                    <Button
                    ...
                    <div className="space-y-4 mt-2">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          placeholder="مثال: حي النخيل، شمال الرياض"
                        />
                      </div>
                      <div className="space-y-2">
              ...
              <div className="flex items-center justify-between p-4 bg-muted/30 rounded-xl">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      الدفع عبر تطبيق STC Pay
                    </p>
                  </div>
                </div>
                <Switch checked={stcPayEnabled} onCheckedChange={setStcPayEnabled} />
              </div>
                ...
                <div key={method.id} className="flex items-center justify-between p-4 bg-muted/30 rounded-xl">
                  ...
                  <div className="flex items-center gap-2">
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        setCustomPaymentMethods((prev) =>
                          prev.map((m) => (m.id === method.id ? { ...m, enabled: checked } : m))
                        )
                      }
                    />
                    <Button
                  ...
                  <div className="space-y-4 mt-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        placeholder="مثال: محفظة إلكترونية، InstaPay"
                      />
                    </div>
                    <div className="space-y-2">
                      <Label>الوصف</Label>
                      <Input
                        ...
                        placeholder="مثال: الدفع عبر المحفظة الإلكترونية"
                      />
                    </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-muted/30 rounded-xl">
                    <div>
                      <h4 className="font-medium text-foreground">الطلبات الجديدة</h4>
                      <p className="text-sm text-muted-foreground">
                  ...
                  <div className="flex items-center justify-between p-4 bg-muted/30 rounded-xl">
                    <div>
                      <h4 className="font-medium text-foreground">التقييمات الجديدة</h4>
                      <p className="text-sm text-muted-foreground">
                  ...
                  <div className="flex items-center justify-between p-4 bg-muted/30 rounded-xl">
                    <div>
                      <h4 className="font-medium text-foreground">الحجوزات الجديدة</h4>
                      <p className="text-sm text-muted-foreground">
                        إشعار عند استلام حجز جديد
                      </p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-center justify-between p-4 bg-muted/30 rounded-xl">
                    <div>
                      <h4 className="font-medium text-foreground">تنبيه انخفاض المخزون</h4>
                      <p className="text-sm text-muted-foreground">
                        إشعار عند انخفاض مخزون أي صنف
                      </p>
                    </div>
                    <Switch
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-4 bg-muted/30 rounded-xl">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="font-medium text-foreground">رسائل SMS</h4>
                        <p className="text-sm text-muted-foreground">
        ...
        <TabsContent value="currency">
          <div className="bg-card rounded-2xl border border-border/50 p-6 space-y-6">
            ...
            <p className="text-sm text-muted-foreground">
              اختر العملة التي سيتم عرضها في جميع أنحاء التطبيق
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
              {CURRENCIES.map((c) => (
                <button
                  ...
                  onClick={() => {
                    setCurrency(c);
                    toast.success(`تم تغيير العملة إلى ${c.nameAr}`);
                  }}
            ...
            <div className="p-4 bg-muted/30 rounded-xl">
              ...
              <p className="text-xs text-muted-foreground mt-1">
                سيتم تطبيق هذه العملة على جميع الأسعار والمبالغ في التطبيق
              </p>
            </div>
          </div>
        </TabsContent>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-card rounded-2xl border border-border/50 p-6 space-y-6">
              ...
              <p className="text-muted-foreground">
                إدارة حسابات المستخدمين والصلاحيات للوصول إلى لوحة التحكم.
              </p>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between p-4 bg-muted/30 rounded-xl">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="font-medium text-foreground">أحمد محمد</h4>
                ...
                <div className="flex items-center justify-between p-4 bg-muted/30 rounded-xl">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="font-medium text-foreground">سارة خالد</h4>
                      <p className="text-sm text-muted-foreground">مدير الطلبات</p>
                    </div>
                  </div>
