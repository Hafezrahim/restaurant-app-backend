      ...
      <div className="space-y-5">
        ...
        <div className="bg-white dark:bg-card rounded-2xl p-5 border border-border/20 shadow-sm relative overflow-hidden">
          ...
          <div className="relative flex items-center gap-4">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-primary to-primary/80 flex items-center justify-center text-white text-xl font-bold shadow-lg shadow-primary/20 overflow-hidden shrink-0">
              {user?.avatarUrl ? (
